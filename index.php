    ...
    <div class="about-me container">
      ...
      <div class="row">
        ...
        <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
          <h3>Web Designer &amp; Web Content Writer</h3>
          <p class="font-italic">
            I am Emerenini Cynthia Ngozi, a client-oriented, meticulous & innovative web designer with over one year of experience in developing contents, responsive web applications, cross browser compatible web pages and general delivery of high quality technology-oriented solutions. 
          </p>
          <p class="font-italic pb-4">
            Extremely passionate towards software architecture and design combined with sensitivity to serve the needs of individuals, small to medium-sized companies/organizations with the use of latest and proven technologies to create outstanding high performance and secure custom contents || websites. *I seek to obtain a creative and challenging position that utilizes knowledge of Web Development & Design. I intend to serve you better!!
          </p>
          <div class="row">
            <div class="col-lg-6">
              <ul>
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          ...
          <div class="resume-item">
            ...
            <p>
            <ul>
              <li>Developed visually appealing, functional and responsive web design.</li>
            </ul>
            <p><em class="border-bottom">Losintech.com, Nigeria</em></p>
            <p>
            <ul>
              <li>Designed, implemented and monitored web pages, pluginsa and functionality for continous improvement</li>
              <li>Oversaw troubleshooting and excellent resolution of bugs.</li>
            </ul>
            </p>
          </div>
          <div class="resume-item">
            ...
            <p>
            <ul>
              <li>Developed quality, creative and simplified web contents.</li>
              <li>Delivers best contents for projects.</li>
            </ul>
            <p><em class="border-bottom">DSC IMSU, Nigeria</em></p>
            <p>
            <ul>
              <li>Covered events in writings.</li>
            </ul>
            </p>
          </div>
        </div>
      ...
      <div class="row portfolio-container mt-5">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item">
          <div class="portfolio-wrap first-child">
            <div class="portfolio-info">
              <h4>Lib-Cater</h4>
              <p>Lib-Cater manages all manual functions of a library. Allows the librarian to maintain library resources in a more operative manner that will help to save their time.</p>
            </div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item">
          <div class="portfolio-wrap">
            <div class="portfolio-info">
              <h4>Losintech</h4>
              <p>(Frontend Design). A top rated custom software development company that designs and 
              develops various sizes of application software.</p>
            </div>
            <div class="portfolio-links d-flex justify-content-between">
              <div class="logo">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item">
          <div class="portfolio-wrap">
            <div class="portfolio-info">
              <h4>HireUs</h4>
              <p>(Frontend Design). Hire over 100,000 experts in various fields.</p>
            </div>
            <div class="portfolio-links d-flex justify-content-between">
              <div class="logo">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item">
          <div class="portfolio-wrap">
            <div class="portfolio-info">
              <h4>CyHotel</h4>
              <p>(Frontend Design). Hotel Booking Template. </p>
            </div>
            <div class="portfolio-links d-flex justify-content-between">
              <div class="img-box">
